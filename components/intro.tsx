    ...
    >
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/devang-shrivastava-2a1909250/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/devangshrivastava"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
      ...
      >
        ...
        <a
          className="mt-2 group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10"
          href="https://devangblogs.vercel.app/"
          download
        >
          My blogpost website!{" "}
